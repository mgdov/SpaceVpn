...
function NewKeyPage() {
    ...
    const loadTariffs = async ()=>{
        setLoading(true);
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$programming$2f$pixel$2d$space$2d$vpn$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPublicTariffsNoAuth"])();
    ...
    const handleCreateKey = async (tariffId)=>{
        setCreating(true);
        setError("");
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$programming$2f$pixel$2d$space$2d$vpn$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createKeyPublic"])({
            tariff_id: tariffId,
...
//# sourceMappingURL=Documents_programming_pixel-space-vpn_c5fb1e14._.js.map