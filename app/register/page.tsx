      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-background px-4 text-muted-foreground text-[8px]">или</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-foreground text-[10px] mb-2">E-mail</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-foreground text-[10px] mb-2">Пароль</label>
          ...
          <div>
            <label className="block text-foreground text-[10px] mb-2">Подтвердите пароль</label>
            <input
              type="password"
